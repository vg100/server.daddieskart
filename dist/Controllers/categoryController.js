...
class categoryController {
    ...
    static getCategoryById(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const category = yield category_1.default.findById(req.category._id);
                if (!category) {
    ...
    static upadteCategory(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const users = yield category_1.default.findByIdAndUpdate(req.category._id, req.body, { new: true });
                res.json(users);
            }
            catch (e) {
                next(e);
